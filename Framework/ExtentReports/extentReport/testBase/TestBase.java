...
public class TestBase {
		...
		if (System.getProperty("os.name").contains("Window")) {
			if (browser.equalsIgnoreCase("firefox")) {
				System.setProperty("webdriver.gecko.driver",
						System.getProperty("user.dir") + "\\DriverMO\\geckodriver.exe");
				...
				System.setProperty("webdriver.ie.driver",
						System.getProperty("user.dir") + "\\DriverIE\\MicrosoftWebDriver.exe");
			...
			System.err.println("Please Enter Correct Platform");
		}
	}
	 ...
	 * String[] split = locator.split(":"); String locatorType = split[0]; String
	 * locatorValue = split[1];
	 * 
	 * if(locatorType.equalsIgnoreCase("ID")||locatorType.equalsIgnoreCase("Id"))
	 * return getGhostDriver().findElement(By.id(locatorValue)); else
	 * if(locatorType.equalsIgnoreCase("Class")||locatorType.equalsIgnoreCase(
	 * "ClassName")) return
	 * getGhostDriver().findElement(By.className(locatorValue)); else
	 * if(locatorType.equalsIgnoreCase("xpath")||locatorType.equalsIgnoreCase(
	 * "Xpath")) return getGhostDriver().findElement(By.xpath(locatorValue)); else
	 * if(locatorType.equalsIgnoreCase("CSS")||locatorType.equalsIgnoreCase(
	 * "CssSeclector")) return
	 * getGhostDriver().findElement(By.cssSelector(locatorValue)); else
	 * if(locatorType.equalsIgnoreCase("LinkText")) return
	 * getGhostDriver().findElement(By.linkText(locatorValue)); else
	 * if(locatorType.equalsIgnoreCase("TagName")) return
	 * getGhostDriver().findElement(By.tagName(locatorValue)); else
	 * if(locatorType.equalsIgnoreCase("PartialLinkText")) return
	 * getGhostDriver().findElement(By.partialLinkText(locatorValue)); else throw
	 * new Exception("Unknown Locator type "+locatorType); }
	 */
	...
	public static WebElement getWebElement(String elementName) throws Exception {
	  ...
	  public static WebElement getPhantomWebElement(String elementName) throws
	  Exception { return getPhantomLocator(prop.getProperty(elementName)); }
