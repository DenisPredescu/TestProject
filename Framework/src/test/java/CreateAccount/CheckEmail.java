...
public class CheckEmail {
	...
	public boolean searchEmail(String userName, String password, final String subjectKeyword, final String fromEmail,
		...
		try {
			...
			for (int i = foundMessages.length - 1; i >= foundMessages.length - 18; i--) {
	 ...
	 * @throws IOException
	 */
	public static void mainGmail(String[] args) throws IOException {
		String userName = "	doesam848+3@gmail.com";
		String password = "test12345678";
		CheckEmail searcher = new CheckEmail();
		String subjectKeyword = "rankingCoach Anmeldung";
		String fromEmail = "rankingCoach Team <support@rankingcoach.com>";
		String bodySearchText = " - Mach deine Firma erfolgreich - mit rankingCoach! Hallo test, bitte klicke auf den unten stehenden Link, um deine Registrierung zu bestätigen. Klicke hier, um fortzufahren Sollte der obenstehende Link";
